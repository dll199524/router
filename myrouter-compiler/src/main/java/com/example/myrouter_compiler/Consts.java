...
public class Consts {
    ...
    public static final String ROUTER_MODULE_PACK_NAME = "com.myrouter.assist.module";
    ...
    public static final String ROUTERACTION = "com.example.myrouter_api.action.RouterAction";
}
